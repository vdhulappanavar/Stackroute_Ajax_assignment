...
function createRow(data , pos){
  ...
  for(let i=pos; i<pos+3; i++){
    ...
    console.log(data[i].poster_path)
      row+=`<article id="${data[i].id}" class="col-sm-4" draggable="true" ondragstart="drag(event)" >
               <div class="panel panel-default panel-front">
                  <div class=" panel-heading">
                    <h4 class="panel-title"><img src="https://image.tmdb.org/t/p/w500/${data[i].poster_path}" id="${data[i].id}" draggable="true" ondragstart="drag(event)"/></h4>
                  </div>
